...
namespace LALE
{
    public class Object
    {
        ...
        public byte[] tiles;
        public List<Object> objectIDs = new List<Object>();

        public void getOverworldObjs(Object objects)
        {
            Object O = new Object();
            switch (objects.id)
            {
        ...
        public Object getOverworldSpecial(Object objects)
        {
            Object O = new Object();
            switch (objects.id)
            {
        ...
        public Object dungeonDoors(Object ob)
        {
            int door = ob.id;
            int y1 = ob.y;
            int x1 = ob.x;
